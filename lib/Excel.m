classdef Excel
    ...
    methods
        ...
        function setValueOfParameter(this, parameterName, parameterValue)
            ...
            [~, y, x] = findCellByName(this, parameterName);              
            range = sprintf('%s%d', this.xlscol(x + SHIFT), y);
            cellValue = num2cell(parameterValue);
            xlswrite(this.path, cellValue, 1, range);
